...
extension AudioStationApi {
    ...
    public func playlistList(limit: Int, offset: Int) async throws -> (total: Int, data: [Playlist])
    {
        let result: PlaylistListResult = try await apiClient.requestForData(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "list",
                parameters: [
                    "library": "all",
                    "limit": limit,
                    "offset": offset,
    ...
    public func playlistSongList(
        ...
        let result: PlaylistGetInfoResult = try await apiClient.requestForData(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "getinfo", version: 3, httpMethod: .post,
                parameters: [
                    "id": id,
                    "library": library,
        ...
        -> String
    {
        let result: PlaylistCreateResult = try await apiClient.requestForData(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "create", version: 3, httpMethod: .post,
                parameters: [
                    "name": name,
                    "library": library,
                    "songs": songs ?? "",
    ...
    public func playlistCreateSmart(
        ...
        let result: PlaylistCreateResult = try await apiClient.requestForData(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "createsmart", version: 2,
                httpMethod: .post,
                parameters: [
                    "name": name,
    ...
    public func playlist_rename(id: String, newName: String) async throws -> String? {
        let result: PlaylistRenameResult = try await apiClient.requestForData(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "rename", version: 3, httpMethod: .post,
                parameters: [
                    "id": id,
                    "new_name": newName,
                ]),
    ...
    public func playlist_delete(id: String) async throws -> Bool {
        let result: PlaylistDeleteResult = try await apiClient.requestForData(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "delete", version: 3, httpMethod: .post,
                parameters: ["id": id]),
    ...
    public func playlistRemoveMissing(id: String) async throws -> Bool {
        try await apiClient.request(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "removemissing", version: 3,
    ...
    public func playlistAddSongs(id: String, songs: [String]) async throws -> Bool {
        ...
        try await apiClient.request(
            ApiEndpoint(
                api: .SYNO_AUDIO_STATION_PLAYLIST, method: "updatesongs", version: 3,
