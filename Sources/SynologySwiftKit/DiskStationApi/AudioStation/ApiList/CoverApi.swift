...
extension AudioStationApi {
    ...
    public func songCoverURL(songId: String) throws -> URL {
        ...
        let api = try SynoDiskStationApi(api: .SYNO_AUDIO_STATION_COVER, method: "getsongcover", parameters: [
            "library": "all",
            "id": songId,
            "_sid": sid,
        ])
    ...
    public func albumCoverURL(albumName: String, albumArtistName: String) throws -> URL {
        ...
        let api = try SynoDiskStationApi(api: .SYNO_AUDIO_STATION_COVER, method: "getcover", version: 3, parameters: [
            "library": "all",
