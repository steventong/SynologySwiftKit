...
extension AudioStationApi {
     ...
     */
    public func songCoverURL(songId: String) async throws -> URL {
        ...
        let api = try await SynoDiskStationApi(api: .SYNO_AUDIO_STATION_COVER, method: "getsongcover", parameters: [
            "library": "all",
            "id": songId,
            "_sid": sid,
        ])
     ...
     */
    public func albumCoverURL(albumName: String, albumArtistName: String) async throws -> URL {
        guard let sid = UserDefaults.standard.string(forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_SID.keyName) else {
            throw SynoDiskStationApiError.invalidSession
        }

        let api = try await SynoDiskStationApi(api: .SYNO_AUDIO_STATION_COVER, method: "getcover", version: 3, parameters: [
            "library": "all",
     ...
     */
    public func artistCoverURL(artistName: String) async throws -> URL {
        guard let sid = UserDefaults.standard.string(forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_SID.keyName) else {
            throw SynoDiskStationApiError.invalidSession
        }
     ...
     */
    public func composerCoverURL(composerName: String) async throws -> URL {
        guard let sid = UserDefaults.standard.string(forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_SID.keyName) else {
            throw SynoDiskStationApiError.invalidSession
        }
