...
extension AudioStationApi {
    ...
    public func songList(limit: Int, offset: Int, song_rating_meq: Int? = nil, sort: (sort_by: String, sort_direction: String)? = nil) async throws -> (total: Int, data: [Song]) {
        ...
        let api = try SynoDiskStationApi(api: .SYNO_AUDIO_STATION_SONG, method: "list", version: 3, parameters: parameters)
    ...
    public func songGetInfo(id: String) async throws -> Song? {
        let api = try SynoDiskStationApi(api: .SYNO_AUDIO_STATION_SONG, method: "getinfo", version: 2, parameters: [
            "id": id,
            "additional": "song_tag,song_audio,song_rating",
        ])
    ...
    public func songSetRating(id: String, rating: Int) async throws -> Bool {
        let api = try SynoDiskStationApi(api: .SYNO_AUDIO_STATION_SONG, method: "setrating", version: 2, parameters: [
            "id": id,
            "rating": rating,
        ])
