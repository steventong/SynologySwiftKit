...
public class DeviceConnection: DeviceConnectionProviding {
    ...
    private let ONE_YEAR_SECONDS = 31_536_000
    ...
    public func getCurrentConnectionUrl() -> (type: ConnectionType, url: String)? {
        ...
        if let url = UserDefaults.standard.string(
            forKey: UserDefaultsKeys.DISK_STATION_CONNECTION_URL.keyName)
        {
    ...
    public func getSessionUsername() -> String? {
        return UserDefaults.standard.string(
            forKey: UserDefaultsKeys.DISK_STATION_CONNECTION_USERNAME.keyName)
    }
    ...
    public func getLoginSession() -> (
        ...
        let sidExpireAt: Date? =
            UserDefaults.standard.object(
                forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_SID_EXPIRE_AT.keyName) as? Date
            ?? nil
        let did = UserDefaults.standard.string(
            forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_DID.keyName)
        let didExpireAt: Date? =
            UserDefaults.standard.object(
                forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_DID_EXPIRE_AT.keyName) as? Date
            ?? nil
    ...
    public func getLoginServer() -> (server: String, isEnableHttps: Bool)? {
        ...
        if let server = UserDefaults.standard.string(
            forKey: UserDefaultsKeys.DISK_STATION_SERVER.keyName)
        {
            let isEnableHttps = UserDefaults.standard.bool(
                forKey: UserDefaultsKeys.DISK_STATION_SERVER_ENABLE_HTTPS.keyName)
    ...
    public func updateLoginSession(username: String, sid: String, did: String?) {
        ...
        UserDefaults.standard.setValue(
            sid, forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_SID.keyName)
        UserDefaults.standard.setValue(
            session.sidExpireAt,
            forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_SID_EXPIRE_AT.keyName)

        if let did {
            UserDefaults.standard.setValue(
                did, forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_DID.keyName)
            UserDefaults.standard.setValue(
                session.didExpireAt,
                forKey: UserDefaultsKeys.DISK_STATION_AUTH_SESSION_DID_EXPIRE_AT.keyName)
        } else {
        ...
        UserDefaults.standard.setValue(
            username, forKey: UserDefaultsKeys.DISK_STATION_CONNECTION_USERNAME.keyName)
    ...
    public func updateCurrentConnectionUrl(type: ConnectionType, url: String) {
        ...
        UserDefaults.standard.setValue(
            url, forKey: UserDefaultsKeys.DISK_STATION_CONNECTION_URL.keyName)
        UserDefaults.standard.setValue(
            type.rawValue, forKey: UserDefaultsKeys.DISK_STATION_CONNECTION_TYPE.keyName)

        UserDefaults.standard.synchronize()
        Logger.info(
            "[DeviceConnection]update Connection to userdefaults, connection = \(connection!)")
    }
    ...
    public func updateLoginPreferences(server: String, isEnableHttps: Bool) {
        ...
        UserDefaults.standard.setValue(
            isEnableHttps, forKey: UserDefaultsKeys.DISK_STATION_SERVER_ENABLE_HTTPS.keyName)
