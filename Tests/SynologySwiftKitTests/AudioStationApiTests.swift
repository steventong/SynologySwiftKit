...
final class AudioStationApiTests: XCTestCase {
    ...
    func testGetApiInfo() async throws {
        ...
        let lowQualityURL = try audioStationApi.songStreamUrl(musicId: "music_1234", quality: .LOW)
        let mediumQualityURL = try audioStationApi.songStreamUrl(musicId: "music_1234", quality: .MEDIUM)
        let highQualityURL = try audioStationApi.songStreamUrl(musicId: "music_1234", quality: .HIGH)
